...
interface DedicatedTrenchSectionProps {
  product: Product;
  specificationList: Specification[];
}

export default function DedicatedTrenchSection({
  product,
  specificationList,
}: DedicatedTrenchSectionProps) {
  ...
  // Color variants for the classic cotton trench
  const colorVariants: ColorVariant[] = [
    { name: "Khaki", hex: "#C4B57E", image: product.images[0].url, available: true },
    { name: "Navy Blue", hex: "#1e3a8a", image: "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=1600&q=80&auto=format&fit=crop", available: true },
    ...
    { name: "Camel", hex: "#C4A484", image: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=1600&q=80&auto=format&fit=crop", available: false },
  ];
