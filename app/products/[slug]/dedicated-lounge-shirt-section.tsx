...
interface SilkBlendLoungeShirtSectionProps {
  product: Product;
  specificationList: Specification[];
}

export default function SilkBlendLoungeShirtSection({
  product,
  specificationList,
}: SilkBlendLoungeShirtSectionProps) {
  ...
  // Color variants for the silk blend lounge shirt
  const colorVariants: ColorVariant[] = [
    { name: "Black", hex: "#000000", image: product.images[0].url, available: true },
    { name: "Champagne", hex: "#f5f5dc", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=1600&q=80&auto=format&fit=crop", available: true },
    ...
    { name: "Rose Gold", hex: "#e0b4b4", image: "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=1600&q=80&auto=format&fit=crop", available: false },
  ];
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-baseline space-x-4">
                  ...
                  <span className="text-sm text-gray-500 uppercase tracking-wide">
                    Premium silk-blend construction
                  </span>
                </div>
