...
interface DedicatedDressSectionProps {
  product: Product;
  specificationList: Specification[];
}

export default function DedicatedDressSection({
  product,
  specificationList,
}: DedicatedDressSectionProps) {
  ...
  // Color variants for the silk slip dress
  const colorVariants: ColorVariant[] = [
    { name: "Black", hex: "#000000", image: product.images[0].url, available: true },
    { name: "Nude", hex: "#F5F5DC", image: "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=1600&q=80&auto=format&fit=crop", available: true },
    { name: "Burgundy", hex: "#7f1d1d", image: "https://images.unsplash.com/photo-1544966503-7cc5ac882d5d?w=1600&q=80&auto=format&fit=crop", available: true },
    { name: "Emerald", hex: "#064e3b", image: "https://images.unsplash.com/photo-1520974735194-0a2a20f98b6f?w=1600&q=80&auto=format&fit=crop", available: false },
  ];
