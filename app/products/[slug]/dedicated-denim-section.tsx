...
interface DedicatedDenimSectionProps {
  product: Product;
  specificationList: Specification[];
}

export default function DedicatedDenimSection({
  product,
  specificationList,
}: DedicatedDenimSectionProps) {
  ...
  // Color variants for the selvedge straight denim
  const colorVariants: ColorVariant[] = [
    { name: "Indigo", hex: "#1e3a8a", image: product.images[0].url, available: true },
    { name: "Raw Denim", hex: "#E8E8E8", image: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=1600&q=80&auto=format&fit=crop", available: true },
    { name: "Black", hex: "#000000", image: "https://images.unsplash.com/photo-1544966503-7cc5ac882d5d?w=1600&q=80&auto=format&fit=crop", available: true },
    { name: "Dark Wash", hex: "#2d3748", image: "https://images.unsplash.com/photo-1520974735194-0a2a20f98b6f?w=1600&q=80&auto=format&fit=crop", available: false },
  ];
