...
interface CottonOxfordShirtSectionProps {
  product: Product;
  specificationList: Specification[];
}

export default function CottonOxfordShirtSection({
  product,
  specificationList,
}: CottonOxfordShirtSectionProps) {
  ...
  // Color variants for the cotton oxford shirt
  const colorVariants: ColorVariant[] = [
    { name: "White", hex: "#ffffff", image: product.images[0].url, available: true },
    { name: "Light Blue", hex: "#dbeafe", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=1600&q=80&auto=format&fit=crop", available: true },
    { name: "Oxford Blue", hex: "#1e40af", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1600&q=80&auto=format&fit=crop", available: true },
