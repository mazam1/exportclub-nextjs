...
interface PremiumSupimaTeeSectionProps {
  product: Product;
  specificationList: Specification[];
}

export default function PremiumSupimaTeeSection({
  product,
  specificationList,
}: PremiumSupimaTeeSectionProps) {
  ...
  // Color variants for the premium supima tee
  const colorVariants: ColorVariant[] = [
    { name: "Charcoal", hex: "#374151", image: product.images[0].url, available: true },
    { name: "White", hex: "#ffffff", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=1600&q=80&auto=format&fit=crop", available: true },
    { name: "Navy", hex: "#1e3a8a", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1600&q=80&auto=format&fit=crop", available: true },
    { name: "Sage Green", hex: "#84cc16", image: "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=1600&q=80&auto=format&fit=crop", available: false },
  ];
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <header className="mb-8">
              <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <a href="/essentials" className="hover:text-gray-900 transition-colors">Essentials</a>
                <span aria-hidden="true">/</span>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-baseline space-x-4">
                  ...
                  <span className="text-sm text-gray-500 uppercase tracking-wide">
                    Premium Supima cotton construction
                  </span>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Unisex sizing • {product.stock} pieces available
                  </p>
                </div>
